        ...
        {!user.status ? (
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem asChild className="hover:bg-blue-100 cursor-pointer">
                <Link to="/profile">
                  <FaRegUser  />
                  Profile
                </Link>
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={handleLogout} className="text-red-600 hover:bg-red-100 cursor-pointer">
